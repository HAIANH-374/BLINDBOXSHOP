...
class AdminRecentOrders extends ConsumerStatefulWidget {
  const AdminRecentOrders({super.key});

  @override
  ConsumerState<AdminRecentOrders> createState() => _AdminRecentOrdersState();
}

class _AdminRecentOrdersState extends ConsumerState<AdminRecentOrders> {
  int _refreshKey = 0;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<OrderEntity>>(
      ...
      future: ref.read(getAllOrdersUseCaseProvider).call(),
  ...
  Future<void> _confirmOrder(BuildContext context, OrderEntity order) async {
    try {
      await ref.read(confirmOrderUseCaseProvider).call(order.id);

...
class OrderDetailPage extends ConsumerWidget {
  ...
  Widget _buildOrderDetails(BuildContext context, OrderEntity order) {
    return ListView(
      ...
      children: [
        // Phần đầu: mã đơn, trạng thái, ngày tạo
  ...
  Widget _buildAddress(BuildContext context, OrderEntity order) {
  ...
  Widget _buildItems(BuildContext context, OrderEntity order) {
    return Container(
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildTotals(BuildContext context, OrderEntity order) {
    return Container(
      padding: EdgeInsets.all(16.w),
      decoration: BoxDecoration(
        color: Colors.white,
